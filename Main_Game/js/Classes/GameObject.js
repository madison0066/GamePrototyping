...
{	
	...
	this.drawFire = function()
	{
		...
		context.translate(this.x, this.y);
		//context.fillRect((-this.width/2), (-this.height/2), this.width, this.height);
		context.drawImage(fireSprite, (-this.width/2), (-this.height/2), this.width, this.height);
		context.restore();
	}	
	...
	this.drawDebug = function()
	{
		...
		context.fillRect(this.left().x-size/2, this.bottom().y-size/2, size, size);
		context.fillRect(this.right().x-size/2, this.bottom().y-size/2, size, size);
		context.restore();
	}
}
